...
void SparseMatrixOutline::AddBlock2x2Entry(int i, int j, const double * matrix2x2)
{
  for(int k=0; k<2; k++)
    for(int l=0; l<2; l++)
      AddEntry(2*i+k,2*j+l,matrix2x2[2*k+l]);
}

void SparseMatrixOutline::AddBlock2x2Entry(int i, int j, double value)
{
  for(int k=0; k<2; k++)
    for(int l=0; l<2; l++)
      AddEntry(2*i+k,2*j+l,value);
}
