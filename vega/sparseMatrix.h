...
public:
  ...
  // add a 2x2 matrix at location (2*i, 2*j)
  void AddBlock2x2Entry(int i, int j, const double * matrix2x2); // matrix2x2 should be given in row-major order
  void AddBlock2x2Entry(int i, int j, double value=0.0); // matrix is assigned the value at all 3x3 elements
